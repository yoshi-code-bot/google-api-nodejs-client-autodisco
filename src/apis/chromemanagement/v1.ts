...
export namespace chromemanagement_v1 {
   ...
   */
  export interface Schema$GoogleChromeManagementVersionsV1ConnectorConfig {
    /**
     ...
     */
    status?: Schema$GoogleChromeManagementVersionsV1ConnectorConfigStatus;
    /**
   ...
   */
  export interface Schema$GoogleChromeManagementVersionsV1ConnectorConfigDetails {
    /**
     * CrowdStrike connector config.
     */
    crowdStrikeConfig?: Schema$GoogleChromeManagementVersionsV1CrowdStrikeConfig;
    /**
     * CrowdStrike Falcon Next Gen connector config.
     */
    crowdStrikeFalconNextGenConfig?: Schema$GoogleChromeManagementVersionsV1CrowdStrikeFalconNextGenConfig;
    /**
     * CrowdStrike XDR connector config.
     */
    crowdStrikeXdrConfig?: Schema$GoogleChromeManagementVersionsV1CrowdStrikeXdrConfig;
    /**
     * Device trust connector config.
     */
    deviceTrustConfig?: Schema$GoogleChromeManagementVersionsV1DeviceTrustConfig;
    /**
     ...
     */
    pubSubConfig?: Schema$GoogleChromeManagementVersionsV1PubSubConfig;
    /**
   ...
   */
  export interface Schema$GoogleChromeManagementVersionsV1ConnectorConfigStatus {
    /**
   ...
   */
  export interface Schema$GoogleChromeManagementVersionsV1DeviceTrustConfig {
    /**
   ...
   * Pub/Sub connector config.
   */
  export interface Schema$GoogleChromeManagementVersionsV1PubSubConfig {
    /**
   ...
   */
  export interface Schema$GoogleChromeManagementVersionsV1ReportingSettings {
    /**
     ...
     */
    enabledDefaultEvents?: string[] | null;
    /**
     ...
     */
    enabledDeviceEvents?: string[] | null;
    /**
   ...
   */
  export interface Schema$GoogleChromeManagementVersionsV1XdrSettings {
    /**
     * Required. Whether to enable all XDR events.
     */
    enableAllXdrEvents?: boolean | null;
  }
  /**
  ...
  export class Resource$Customers$Connectorconfigs {
     ...
     */
    create(
      params: Params$Resource$Customers$Connectorconfigs$Create,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    create(
      params?: Params$Resource$Customers$Connectorconfigs$Create,
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>
    >;
    create(
      params: Params$Resource$Customers$Connectorconfigs$Create,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    create(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>,
      callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>
    ): void;
    create(
      params: Params$Resource$Customers$Connectorconfigs$Create,
      callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>
    ...
    create(
      paramsOrCallback?:
        | Params$Resource$Customers$Connectorconfigs$Create
        | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Customers$Connectorconfigs$Create;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Customers$Connectorconfigs$Create;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>(
          parameters
        );
      }
    }
     ...
     *
     *   // Do the magic
     *   const res = await chromemanagement.customers.connectorConfigs.delete({
     *     // Required. Format: customers/{customer\}/connectorConfigs/{connector_config\}
     *     name: 'customers/my-customer/connectorConfigs/my-connectorConfig',
     *   });
     *   console.log(res.data);
     *
     *   // Example response
     ...
     */
    delete(
      params: Params$Resource$Customers$Connectorconfigs$Delete,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    delete(
      params?: Params$Resource$Customers$Connectorconfigs$Delete,
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Customers$Connectorconfigs$Delete
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Customers$Connectorconfigs$Delete;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Customers$Connectorconfigs$Delete;
        options = {};
      }
     ...
     *
     *   // Do the magic
     *   const res = await chromemanagement.customers.connectorConfigs.get({
     *     // Required. Format: customers/{customer\}/connectorConfigs/{connector_config\}
     *     name: 'customers/my-customer/connectorConfigs/my-connectorConfig',
     *   });
     *   console.log(res.data);
     ...
     */
    get(
      params: Params$Resource$Customers$Connectorconfigs$Get,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    get(
      params?: Params$Resource$Customers$Connectorconfigs$Get,
    ...
    get(
      paramsOrCallback?:
        | Params$Resource$Customers$Connectorconfigs$Get
        | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Customers$Connectorconfigs$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Customers$Connectorconfigs$Get;
        options = {};
      }
     ...
     *
     *   // Do the magic
     *   const res = await chromemanagement.customers.connectorConfigs.list({
     ...
     */
    list(
      params: Params$Resource$Customers$Connectorconfigs$List,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    list(
      params?: Params$Resource$Customers$Connectorconfigs$List,
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>
    >;
    list(
      params: Params$Resource$Customers$Connectorconfigs$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>,
      callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>
    ): void;
    list(
      params: Params$Resource$Customers$Connectorconfigs$List,
      callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Customers$Connectorconfigs$List
        | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Customers$Connectorconfigs$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Customers$Connectorconfigs$List;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>(
          parameters
        );
      }
    }
     ...
     *
     *   // Do the magic
     *   const res = await chromemanagement.customers.connectorConfigs.patch({
     *     // Identifier. Format: customers/{customer\}/connectorConfigs/{connector_config\}
     *     name: 'customers/my-customer/connectorConfigs/my-connectorConfig',
     ...
     */
    patch(
      params: Params$Resource$Customers$Connectorconfigs$Patch,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    patch(
      params?: Params$Resource$Customers$Connectorconfigs$Patch,
    ...
    patch(
      paramsOrCallback?:
        | Params$Resource$Customers$Connectorconfigs$Patch
        | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Customers$Connectorconfigs$Patch;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Customers$Connectorconfigs$Patch;
        options = {};
      }
  ...
  export interface Params$Resource$Customers$Connectorconfigs$Delete extends StandardParameters {
    /**
     * Required. Format: customers/{customer\}/connectorConfigs/{connector_config\}
     */
    name?: string;
  }
  export interface Params$Resource$Customers$Connectorconfigs$Get extends StandardParameters {
    /**
     * Required. Format: customers/{customer\}/connectorConfigs/{connector_config\}
     */
    name?: string;
  }
  export interface Params$Resource$Customers$Connectorconfigs$List extends StandardParameters {
    /**
     * Optional. The maximum number of connector configs to return. The default page size is 50 if page_size is unspecified, and the maximum page size allowed is 100. Values above 100 will be capped at 100.
     */
    pageSize?: number;
  ...
  export interface Params$Resource$Customers$Connectorconfigs$Patch extends StandardParameters {
    /**
     * Identifier. Format: customers/{customer\}/connectorConfigs/{connector_config\}
     */
    name?: string;
